...
tags:
  ...
  - TypeScript
  - Memory Runtime
summary: "LoopTrain 从当前 standalone v0.5 到分层 Runtime 架构的公开技术规格：Memory Runtime 边界、CompanionView、Deterministic Assistant Runtime、LLM expression boundary 及 Slice 0 实施基线。"
sourceDraft: "docs/superpowers/specs/runtime-architecture-design.revised.zh.md"
pinned: false
---
