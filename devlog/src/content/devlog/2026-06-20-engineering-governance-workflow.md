...
## 背景：为什么要建立工程规范
作者说：由于这个项目本身是实验性质，所以在开发初期，尝试了很多的东西，由于现在基本是AI来写代码，我输入意图，通过对话，但是我希望把整个过程都留存下来，因此必须通过文档来留痕。但是初期，由于没有规范，文档散落在各个地方，由于我会用不同的工具开发，导致文档位置非常随意。其实之前我已经有过两次文档整理，但是当时没有想清楚，效果非常不好。终于，我把这个流程完整的工程化和规范化，现在开发简直神清气爽，至于怎么做，大家请看VCR：
