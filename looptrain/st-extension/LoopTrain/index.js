...
(function () {
  ...
  function buildNpcRawPrompt(npcId, playerText) {
    ...
    const npcProfiles = {
      xiaoning: '小宁：十岁左右的女孩，抱着旧布娃娃，害怕、敏感，不会用成人推理语言。她可以表达听见地板下方滴答声，但不能说出炸弹真相。关于她的母亲：小宁只会在信任足够时简单说这是妈妈给的布娃娃，绝不会编造妈妈出远门/去世/在何处等不存在的信息，也绝不用哥哥/姐姐/叔叔/阿姨称谓称呼玩家。',
    ...
    const systemPrompt =
      ...
      `8. 不要给玩家起称谓（如哥哥、姐姐、叔叔、阿姨等），玩家身份是普通乘客。\n` +
      `9. 不要编造不存在的人物信息、人物去向或新人物关系。\n` +
      `10. 输出请控制在 60 字以内。\n\n` +
